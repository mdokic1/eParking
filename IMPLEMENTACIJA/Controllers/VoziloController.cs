...
namespace EParkingOOAD.Controllers
{
    public class VoziloController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ModelAuta,BrojTablice,BrojSasije,BrojMotora,KorisnikId")] Vozilo vozilo)
        {
            if (ModelState.IsValid)
            {
                _context.Add(vozilo);
                //Zahtjev zahtjev = new Zahtjev(vozilo.ID, vozilo.KorisnikId);
